...
export default [
    ...
    route("apps", "routes/seo/apps.tsx"),
    ...
    route("api/computer/hint", "routes/api.computer.hint.ts"),
    route("api/chatgpt/*", "routes/api.chatgpt.$.ts"),
    route("api/grok/*", "routes/api.grok.$.ts"),
    route("api/kimi/*", "routes/api.kimi.$.ts"),
    ...
    route("api/composio", "routes/api.composio.ts"),
